### match new asci values with old - swap out
...
new_algae_codes <- unique(algae_v2$StationCode)
algae_codes <- unique(algae_asci_ffm_ann_trim$StationID)

sum(new_algae_codes %in% algae_codes) ## 235

## join new asci values
algae_asci_ffm_ann_trim2 <- left_join(algae_asci_ffm_ann_trim, algae_v2, by="StationID")
algae_asci_ffm_ann_trim2

algae_asci_ffm_ann2 <- left_join(algae_asci_ffm_ann, algae_v2, by="StationID")
algae_asci_ffm_ann2

save(algae_asci_ffm_ann_trim2,file= "output_data/05_selected_algae_ascii_ffm_ann_trim2.rda")
save(algae_asci_ffm_ann2,file= "output_data/05_selected_algae_ascii_ffm_ann2.rda")
