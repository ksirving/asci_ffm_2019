...
names(algae_asci_flow_annual)
data_ann <- dplyr::select(algae_asci_flow_annual, 1:3, 5,6,14, 20, one_of(algae.metrics), 4,33:66) %>% 
...
dat_mmi_hyb <- data_ann[,c(8,15:(ncol(data_ann)-1))]
names(dat_mmi_hyb) 
...
ggsave(filename = "figs/ann/ann_brt_mmi_hybrid_top_RI_barplot.png",width = 7, height = 7, units = "in", dpi = 300)

###################################################
# OxyRed.DO_30.richness Annual BRT --------------------------------------------------------
names(data_ann)
# this matches algae from same year against flow from same year
...
# select cols of interest
dat_OxyRed <- data_ann[,c(9,15:(ncol(data_ann)-1))]
names(dat_OxyRed) 
...
ggplot(data=gbm1_ri_top, aes(x=varnames,y=RI)) +
  geom_bar(position="dodge",stat="identity") +
  coord_flip() +
  labs(title=paste0("Annual: Top ",gbm1_topn," vars for OxyRed 30"))

ggsave(filename = "figs/ann/ann_brt_OxyRed_top_RI_barplot.png",width = 7, height = 7, units = "in", dpi = 300)

###################################################
# prop.spp.BCG4 Annual BRT --------------------------------------------------------
names(data_ann)
# this matches algae from same year against flow from same year
...
# select cols of interest
dat_BCG4 <- data_ann[,c(10,15:(ncol(data_ann)-1))]
names(dat_BCG4) 
...
ggplot(data=gbm1_ri_top, aes(x=varnames,y=RI)) +
  geom_bar(position="dodge",stat="identity") +
  coord_flip() +
  labs(title=paste0("Annual: Top ",gbm1_topn," vars for BCG4"))

ggsave(filename = "figs/ann/ann_brt_BCG4_top_RI_barplot.png",width = 7, height = 7, units = "in", dpi = 300)

###################################################
# Salinity.BF.richness Annual BRT --------------------------------------------------------
names(data_ann)
# this matches algae from same year against flow from same year
...
# select cols of interest
dat_Salinity <- data_ann[,c(11,15:(ncol(data_ann)-1))]
names(dat_Salinity) 
...
ggplot(data=gbm1_ri_top, aes(x=varnames,y=RI)) +
  geom_bar(position="dodge",stat="identity") +
  coord_flip() +
  labs(title=paste0("Annual: Top ",gbm1_topn," vars for Salinity"))

ggsave(filename = "figs/ann/ann_brt_Salinity_top_RI_barplot.png",width = 7, height = 7, units = "in", dpi = 300)




###################################################
# prop.spp.IndicatorClass_DOC_high_raw Annual BRT --------------------------------------------------------
names(data_ann)
# this matches algae from same year against flow from same year
...
# select cols of interest
dat_doc <- data_ann[,c(12,15:(ncol(data_ann)-1))]
names(dat_doc) 
...
ggplot(data=gbm1_ri_top, aes(x=varnames,y=RI)) +
  geom_bar(position="dodge",stat="identity") +
  coord_flip() +
  labs(title=paste0("Annual: Top ",gbm1_topn," vars for DOC"))

ggsave(filename = "figs/ann/ann_brt_DOC_top_RI_barplot.png",width = 7, height = 7, units = "in", dpi = 300)
...
# select cols of interest
dat_MMI.sba <- data_ann[,c(13,15:(ncol(data_ann)-1))]
names(dat_MMI.sba) 
...
ggplot(data=gbm1_ri_top, aes(x=varnames,y=RI)) +
  geom_bar(position="dodge",stat="identity") +
  coord_flip() +
  labs(title=paste0("Annual: Top ",gbm1_topn," vars for MMI Soft Bodied Algae"))

ggsave(filename = "figs/ann/ann_brt_MMI_sba_top_RI_barplot.png",width = 7, height = 7, units = "in", dpi = 300)
...
# select cols of interest
dat_MMI.d <- data_ann[,c(14,15:(ncol(data_ann)-1))]
names(dat_MMI.d) 
...
ggplot(data=gbm1_ri_top, aes(x=varnames,y=RI)) +
  geom_bar(position="dodge",stat="identity") +
  coord_flip() +
  labs(title=paste0("Annual: Top ",gbm1_topn," vars for MMI Diatoms"))

ggsave(filename = "figs/ann/ann_brt_MMI_d_top_RI_barplot.png",width = 7, height = 7, units = "in", dpi = 300)
