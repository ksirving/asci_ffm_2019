...
# #save out for later
save(ri_all_regions, file = "models/07_all_ri_all_regions_asci_ann.rda")


# Make a Table of RI's ----------------------------------------------------

load(file="models/07_all_ri_all_regions_asci_ann.rda")
library(readxl)
...
# save out
plot_savename2 <- "07_gbm_asci_ann_regional"
